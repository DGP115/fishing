  ...
  connect() {
    ...
    /* To now write the min/max values of the slider back to the DOM:
        ...
        2.  The slider has a method called "on" that takes an event and a callback function as
            inputs.   When a slider handle is changed by the user, an "update" event is triggered.  Use that event to write the slider handle's back value to the DOM.
        ...
        4.  Wtih all the necessary variable values set, trigger the update of the fish catches list.
            ...
            So, trigger that event.  Use teh bubbles="true" so the event is seen by listeners above us in the DOM
    */
